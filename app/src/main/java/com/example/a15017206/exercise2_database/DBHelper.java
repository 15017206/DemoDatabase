...
public class DBHelper extends SQLiteOpenHelper {
    ...
    // Trying to retrieve record - column description only
    public ArrayList<String> getTaskContent() {
        ...
        return tasks;
    } // end of ArrayList getTaskContent method

    // Trying to retrieve record - everything
    public ArrayList<Task> getTasks() {
        ...
        cursor.close();
        db.close();
        return tasks; // return the ArrayList of Task
    } // end of ArrayList getTasks
